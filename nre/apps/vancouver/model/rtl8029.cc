...
public:
    ...
    Rtl8029(DBus<MessageNetwork> &bus_network, DBus<MessageIrqLines> &bus_irqlines, unsigned char irq,
    ...
    "If no bdf is given a free one is used.")
{
    ...
    Rtl8029 *dev =
        new Rtl8029(mb.bus_network, mb.bus_irqlines, argv[1], msg.mac,
