...
public:
	...
	void read(nre::Storage::tag_type tag,nre::Storage::sector_type sector,const nre::Storage::dma_type *dma) {
		_sess.read(tag,sector,*dma);
	}
	void write(nre::Storage::tag_type tag,nre::Storage::sector_type sector,const nre::Storage::dma_type *dma) {
