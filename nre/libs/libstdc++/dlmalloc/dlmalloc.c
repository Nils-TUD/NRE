...
#ifndef LACKS_STDDEF_H
#include <stddef.h>  /* For size_t */
#endif  /* LACKS_STDDEF_H */
...
static MLOCK_T malloc_global_mutex;
void dlmalloc_init_locks(void) { INITIAL_LOCK(&malloc_global_mutex); }
...
/* Realloc using mmap */
static mchunkptr mmap_resize(mstate m, mchunkptr oldp, size_t nb, UNUSED int flags) {
      ...
      if (!is_extern_segment(sp)) {
        if (is_mmapped_segment(sp)) {
          if (HAVE_MMAP &&
            ...
            UNUSED size_t newsize = sp->size - extra;
